...
<body>
    ...
    <section class="provide-department">
        <div class="container">
            <div class="text-center">
                <h6 class="sub-heading-tp">Discover Our Diverse Offerings</h6>
                <h2 class="diffr-headimg">Our Categories</h2>
            </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                    <a class="descript-some" href="{{route('listing.category',$value->cnameslug)}}">
                        <div class="dizcript-card text-center">
                            <img src="{{asset('storage/category/'.$value->cimage)}}" alt="Housing Image">
                        </div>
                        <h5>{{$value->cname}}</h5>
                        <span class="readmore-btn">
                            Explore <i class="fas fa-arrow-circle-right"></i>
                        </span>
                    </a>
                </div>
                @endforeach
                ...
                <div class="col-sm-12 pt-5 pb-5 hegt-matain">
                    <h2 class="text-danger">Category Not Available</h2>
                </div>
                @endif
            </div>
        </div>
    ...
    <div class="container mt-5 pb-5">
        <div class="text-center">
            <h5>Our Service Offerings {{$listingcount}}</h5>
        ...
        <div class="row justify-content-center">
            ...
            @else
            <div class="col-sm-12 pt-5 pb-5 hegt-matain">
                <h2 class="text-danger">Listing Not Available</h2>
            </div>
            @endif
        </div>
    </div>
