...
<div class="form-layouts-area">
    <div class="container-fluid">
        <div class="card-box-style">
            ...
            <form class="row g-3" action="{{route('category.save')}}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="col-md-6">
                    <label class="form-label">Category Name</label>
                    <input type="text" id="InputCat_name" class="form-control" name="cname">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Category Slug</label>
                    <input type="text" id="InputSlug" class="form-control" name="cnameslug">
                </div>
                <div class="col-md-12">
